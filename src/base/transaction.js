...
Transaction.prototype.create = function (data) {
  ...
  // trs.signature = "5585bb6b54968b59cc947a3449807c46962ebce37db9be0bac076c9b8f43c59bdaa0c429238634f0638e2ebc24c90e4e62622f05ababd665eb970149d7eedf0d";
...
Transaction.prototype.verifySignature = function (trs, publicKey, signature) {
  ...
  if(trs.type === 26) {
    try {
      var bytes = this.getBytes(trs, true, true);
      var res = this.verifyBytes(bytes, trs.asset.transferfrom.s_pk, signature);
