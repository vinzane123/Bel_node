...
module.exports.connect = function (connectString, cb) {
  ...
  var sql = [
    ...
    "CREATE TABLE IF NOT EXISTS dapps(transactionId VARCHAR(64) NOT NULL,owner VARCHAR(64) NOT NULL, name VARCHAR(32) NOT NULL, description VARCHARH(160), tags VARCHARH(160), link TEXT, type INTEGER NOT NULL, category INTEGER NOT NULL, icon TEXT, delegates TEXT, unlockDelegates, FOREIGN KEY(transactionId) REFERENCES trs(id) ON DELETE CASCADE)",
    ...
    "CREATE TABLE IF NOT EXISTS approve(owner VARCHAR(255) NOT NULL, spender VARCHAR(255) NOT NULL, amount INT NOT NULL,transactionId VARCHAR(64) NOT NULL, senderPublicKey BINARY(32) NOT NULL)",
    // Created approve table and added owner field to the dapp. 
