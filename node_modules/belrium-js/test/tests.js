...
var belrium = require("../index.js");

describe("Belrium JS", function () {

	it("should be ok", function () {
		(belrium).should.be.ok;
	});

	it("should be object", function () {
		(belrium).should.be.type("object");
	});
	...
	it("should have properties", function () {
		...
		properties.forEach(function (property) {
			(belrium).should.have.property(property);
		});
	});

	describe("crypto.js", function () {
		var crypto = belrium.crypto;
	...
	describe("dapp.js", function () {
		...
		describe("#createDApp", function () {
			...
			var options = {
				"name": "belrium-dapp-cctime",
				"link": "https://github.com/belriumPlatform/belrium-dapp-cctime/archive/master.zip",
				"category": 1,
				"description": "Decentralized news channel",
				"tags": "belrium,dapp,demo,cctime",
			...
			describe("returned dapp", function () {
				var keys = belrium.crypto.getKeys("secret");
				var secondKeys = belrium.crypto.getKeys("secret 2");
				...
				it("should be signed correctly", function () {
					var result = belrium.crypto.verify(trs);
					(result).should.be.ok;
				});
				...
				it("should be second signed correctly", function () {
					trs.amount = 0;
					var result = belrium.crypto.verifySecondSignature(trs, secondKeys.publicKey);
					(result).should.be.ok;
				});
				...
				it("should be ok to verify bytes", function () {
					...
					var secret = 'secret1'
					var keys = belrium.crypto.getKeys(secret)
					var signature = belrium.crypto.signBytes(data1, keys)
					var result = belrium.crypto.verifyBytes(data1, signature, keys.publicKey)
					result.should.be.ok

					var data2 = new Buffer('a1b2c3d4', 'hex')
					signature = belrium.crypto.signBytes(data2, keys)
					result = belrium.crypto.verifyBytes(data2, signature, keys.publicKey)
					result.should.be.ok
				})
			});
		});
	...
	describe("delegate.js", function () {
		...
		describe("#createDelegate", function () {
			...
			describe("returned delegate", function () {
				...
				it("should be signed correctly", function () {
					var result = belrium.crypto.verify(trs, keys.publicKey);
					(result).should.be.ok;
				});
				...
				it("should not be second signed correctly now", function () {
					trs.amount = 100;
					var result = belrium.crypto.verify(trs, secondKeys.publicKey);
					(result).should.be.not.ok;
				});
	...
	describe("signature.js", function () {
		var signature = belrium.signature;
		it("should be ok", function () {
	...
	describe("transaction.js", function () {
		var transaction = belrium.transaction;
		...
		describe("#createTransaction with second secret", function () {
			...
			var keys = belrium.crypto.getKeys(secondSecret);
			...
			describe("returned transaction", function () {
				...
				it("should be second signed correctly", function () {
					var result = belrium.crypto.verifySecondSignature(trs, keys.publicKey);
					(result).should.be.ok;
				});
	...
	describe("vote.js", function () {
		...
		describe("#createVote", function () {
			var createVote = vote.createVote,
				vt = null,
				publicKey = belrium.crypto.getKeys("secret").publicKey,
			...
			describe("returned vote", function () {
				...
				it("should be signed correctly", function () {
					var result = belrium.crypto.verify(vt);
					(result).should.be.ok;
				});

				it("should be second signed correctly", function () {
					var result = belrium.crypto.verifySecondSignature(vt, belrium.crypto.getKeys("second secret").publicKey);
					(result).should.be.ok;
				});
	...
	describe('crypto sha256 and address', function () {
		it('should be equal to the expected address', function () {
			belrium.crypto.getAddress('7a91b9bfc0ea185bf3ade9d264da273f7fe19bf71008210b1d7239c82dd3ad20').should.be.equal('AFbYJhiJb3DXzHy5ZP24mKw21M2dCBJCXP')
			var publicKeyBuffer = new Buffer('7a91b9bfc0ea185bf3ade9d264da273f7fe19bf71008210b1d7239c82dd3ad20', 'hex')
			belrium.crypto.getAddress(publicKeyBuffer).should.be.equal('AFbYJhiJb3DXzHy5ZP24mKw21M2dCBJCXP')
		})
	})
